...
<html>
    ...
    <body>
        <%
            ...
            String alumnos[][] = {{"Contreras Nuño, Jonatan(214423214)","ICCO","CUTonalá","Activo(AC)","NULL"},{"Hernandez Flores, Oscar Ernesto(217726862)","ICCO","CUTonalá","Activo(AC)","NULL"},{"Lopez Perez, Sergio Alberto(211226862)","ICCO","CUTonalá","Activo(AC)","NULL"}};
                ...
                <ul class="indice">
                    ...
                    <li><a href="#"><i class="fas fa-user-tie"></i> Espacio para tutor</a>
                         <ul>
                             ...
                             <li><a href="#"><i class="fas fa-inbox"></i> Buzón de sugerencias</a></li>
                         </ul>
                     </li>   
                </ul>
            </div>
        ...
        <div id="id01" class="modal">
            <div class="modal-contenido">
                <div class="info">
                    <b>Información general del estudiante</b>
                ...
                <div class="datos-estudiante">
                    ...
                    <table class="table-fill"  width="100%">
                            ...
                            <tbody class="table-hover">
                                ...
                                <tr>
                                    <td colspan="3" class="text-left">CONTRERAS NUÑO JONATAN</td>
                ...
                <div class="datos-estudiante"> 
                    <div class="datos">
                        <b>RESULTADOS DEL CURSO DE SELECCIÓN </b>
                    </div>
                    <table class="table-fill"  width="100%">
                        <thead>
                            <tr>
                                <th colspan="2">Fecha de valoración: del 01/ene/2019 al 26/jun 2019</th>
